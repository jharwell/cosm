...
breathe_projects = {"COSM": str(cosm_root / "build/docs/cosm/xml")}
...
doxylink = {
    "cosm": (
        str(cosm_root / "build/docs/cosm/COSM.tag"),
...
xref_links = {
    ...
    "Pini2011": (
        "Pini2011",
        "https://link.springer.com/article/10.1007/s11721-011-0060-1",
    ),
    "Brutschy2014": (
        "Brutschy2014",
        "https://link.springer.com/article/10.1007/s10458-012-9212-y",
    ),
    "Arkin1987": ("Arkin1987", "https://ieeexplore.ieee.org/document/1088037"),
    "SteeringTutorial": (
        "Steering Tutorial",
        "https://gamedevelopment.tutsplus.com/tutorials/search/Steering+Behaviors",
    ),
    "Harwell2020a-demystify": (
        "Harwell2020a",
...
intersphinx_mapping = {
    ...
    "rcppsw": ("https://jharwell.github.io/rcppsw/", None),
}
