 ...
 ******************************************************************************/
arena_map::arena_map(const cfconfig::arena_map_config* config)
    : ER_CLIENT_INIT("cosm.arena.arena_map"),
...
void arena_map::caches_add(const cads::acache_vectoro& caches,
