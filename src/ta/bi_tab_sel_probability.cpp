...
bi_tab_sel_probability::bi_tab_sel_probability(
    ...
    : ER_CLIENT_INIT("cosm.ta.bi_tab_sel_prob"),
...
double bi_tab_sel_probability::calc_random(rmath::rng* rng) {
...
double bi_tab_sel_probability::calc_harwell2019(const ds::bi_tab& tab1,
  ...
  /* Not enough info on one or both TAB's children--explore! */
