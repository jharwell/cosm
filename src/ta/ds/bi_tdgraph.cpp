...
bi_tdgraph::bi_tdgraph(const config::task_alloc_config* const config)
    : ER_CLIENT_INIT("cosm.ta.bi_tdgraph"),
      mc_config(*config),
 ...
 * Member Functions
 ******************************************************************************/
void bi_tdgraph::active_tab_init(const std::string& method, rmath::rng* rng) {
...
void bi_tdgraph::active_tab_init_max_depth(rmath::rng* rng) {
