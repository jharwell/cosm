...
void bi_tab::task_finish_update(polled_task* const finished, rmath::rng* rng) {
...
polled_task* bi_tab::task_allocate(rmath::rng* rng) {
...
std::pair<double, double> bi_tab::subtask_sw_calc(rmath::rng* rng) {
  double prob_12 = 0.0;
  double prob_21 = 0.0;
