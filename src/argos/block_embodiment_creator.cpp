...
block_embodiment_creator::operator()(const cargos::embodied_cube_block* block) const {
...
cargos::block_embodiment_variant
block_embodiment_creator::operator()(const cargos::embodied_ramp_block* block) const {
