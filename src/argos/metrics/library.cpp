...
library::library(void)
    : kStandard({
      ...
      kWithArenaDims2D({  { typeid(csmetrics::dist2D_pos_metrics_collector),
      ...
      kWithArenaDims3D({  { typeid(csmetrics::dist3D_pos_metrics_collector),
      ...
      kWithNBlockClusters({  { typeid(cfmetrics::block_cluster_metrics_collector),
      ...
      kKinematics({  { typeid(ckmetrics::kinematics_metrics_collector),
