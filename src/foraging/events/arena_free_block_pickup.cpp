/**
 * \file arena_free_block_pickup.cpp
 *
 ...
 * Member Functions
 ******************************************************************************/
void arena_free_block_pickup::visit(cfds::arena_map& map) {
  ...
  /*
   * Already holding block mutex from \ref arena_free_block_pickup_interactor, though
