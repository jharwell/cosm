 ...
 * Member Functions
 ******************************************************************************/
cpargos::block_embodiment_variant
block_embodiment_creator::operator()(const cpargos::embodied_cube_block* block) const {
  auto ret = std::make_unique<cpargos::cube_block_embodiment>();
  ::argos::CVector3 loc(
...
cpargos::block_embodiment_variant
block_embodiment_creator::operator()(const cpargos::embodied_ramp_block* block) const {
  auto ret = std::make_unique<cpargos::ramp_block_embodiment>();
...
::argos::CBoxEntity*
block_embodiment_creator::ramp_bottom(const cpargos::embodied_ramp_block* block,
...
::argos::CBoxEntity*
block_embodiment_creator::ramp_back(const cpargos::embodied_ramp_block* block,
                                  const rmath::radians& z_rotation,
                                  const rtypes::type_uuid& parent_id) const {
  double x_factor = 0.0;
  double y_factor = 0.0;
...
::argos::CBoxEntity*
block_embodiment_creator::ramp_top(const cpargos::embodied_ramp_block* block,
                                   const rmath::radians& z_rotation,
                                 const rtypes::type_uuid& parent_id) const {
