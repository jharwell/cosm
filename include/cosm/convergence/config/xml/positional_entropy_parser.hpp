...
#ifndef INCLUDE_COSM_CONVERGENCE_CONFIG_XML_POSITIONAL_ENTROPY_PARSER_HPP_
#define INCLUDE_COSM_CONVERGENCE_CONFIG_XML_POSITIONAL_ENTROPY_PARSER_HPP_
...
#endif /* INCLUDE_COSM_CONVERGENCE_CONFIG_XML_POSITIONAL_ENTROPY_PARSER_HPP_ */
