 ...
 * Namespaces
 ******************************************************************************/
NS_START(cosm, spatial, strategy, nest_acq, config, xml);
...
class nest_acq_parser final : public rer::client<nest_acq_parser>,
 ...
 public:
  ...
  nest_acq_parser(void)
      : ER_CLIENT_INIT("cosm.spatial.strategy.config.xml.nest_acq_parser") {}
...
NS_END(xml, config, nest_acq, strategy, spatial, cosm);
