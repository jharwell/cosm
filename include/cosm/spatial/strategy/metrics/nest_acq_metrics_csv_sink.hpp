/**
 * \file nest_acq_metrics_csv_sink.hpp
 *
 ...
 ******************************************************************************/
/**
 * \class nest_acq_metrics_csv_sink
 * \ingroup spatial metrics
 *
 * \brief Sink for \ref nest_acq_metrics and \ref nest_acq_metrics_collector to
 * output metrics to .csv.
 */
class nest_acq_metrics_csv_sink final : public rmetrics::csv_sink {
 public:
  using collector_type = nest_acq_metrics_collector;

  /**
   * \brief \see rmetrics::csv_sink.
   */
  nest_acq_metrics_csv_sink(fs::path fpath_no_ext,
