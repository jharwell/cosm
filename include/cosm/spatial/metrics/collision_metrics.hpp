...
#ifndef INCLUDE_COSM_SPATIAL_METRICS_COLLISION_METRICS_HPP_
#define INCLUDE_COSM_SPATIAL_METRICS_COLLISION_METRICS_HPP_
...
#endif /* INCLUDE_COSM_SPATIAL_METRICS_COLLISION_METRICS_HPP_ */
