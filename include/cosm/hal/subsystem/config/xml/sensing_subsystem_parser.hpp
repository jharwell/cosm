 ...
 ******************************************************************************/
#if defined(COSM_HAL_TARGET_ARGOS_ROBOT)
using sensing_subsystem_parser = chargos::subsystem::config::xml::sensing_subsystem_parser;
#elif defined(COSM_HAL_TARGET_ROS_ROBOT)
using sensing_subsystem_parser = chros::subsystem::config::xml::sensing_subsystem_parser;
#endif /* COSM_HAL_TARGET_ARGOS_ROBOT */
