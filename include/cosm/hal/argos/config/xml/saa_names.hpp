...
#ifndef INCLUDE_COSM_HAL_ARGOS_CONFIG_XML_SAA_NAMES_HPP_
#define INCLUDE_COSM_HAL_ARGOS_CONFIG_XML_SAA_NAMES_HPP_
 ...
 * Namespaces/Decls
 ******************************************************************************/
NS_START(cosm, hal, argos, config, xml);
...
NS_END(xml, config, argos, hal, cosm);

#endif /* INCLUDE_COSM_HAL_ARGOS_CONFIG_XML_SAA_NAMES_HPP_ */
