...
#ifndef INCLUDE_COSM_HAL_ARGOS_SENSORS_CONFIG_PROXIMITY_SENSOR_CONFIG_HPP_
#define INCLUDE_COSM_HAL_ARGOS_SENSORS_CONFIG_PROXIMITY_SENSOR_CONFIG_HPP_
...
#endif /* INCLUDE_COSM_HAL_ARGOS_SENSORS_CONFIG_PROXIMITY_SENSOR_CONFIG_HPP_ */
