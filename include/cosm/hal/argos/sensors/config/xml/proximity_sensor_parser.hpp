...
#ifndef INCLUDE_COSM_HAL_ARGOS_SENSORS_CONFIG_XML_PROXIMITY_SENSOR_PARSER_HPP_
#define INCLUDE_COSM_HAL_ARGOS_SENSORS_CONFIG_XML_PROXIMITY_SENSOR_PARSER_HPP_
...
#endif /* INCLUDE_COSM_HAL_ARGOS_SENSORS_CONFIG_XML_PROXIMITY_SENSOR_PARSER_HPP_ */
