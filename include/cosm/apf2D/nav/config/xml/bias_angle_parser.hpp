 ...
 *
 * \brief Parses XML configuration for \ref capf2D::nav::bias_angle_generator
 * into \ref bias_angle_config. Assumes it is handed an XML parent in which its
...
class bias_angle_parser final : public rer::client<bias_angle_parser>,
 ...
 public:
  ...
  /**
   * \brief The XML root tag that all \ref capf2D::nav::bias_angle_generator
