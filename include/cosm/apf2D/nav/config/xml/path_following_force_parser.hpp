...
class path_following_force_parser final : public rer::client<path_following_force_parser>,
 ...
 public:
  ...
  path_following_force_parser(void)
      : ER_CLIENT_INIT("cosm.apf2D.nav.config.xml.path_following_force_parser") {}

  /**
   * \brief The XML root tag that all \ref path_following_force configuration
   * should lie under in the XML tree.
   */
  static inline const std::string kXMLRoot = "path_following_force";
