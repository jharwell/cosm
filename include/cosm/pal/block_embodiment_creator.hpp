...
#ifndef INCLUDE_COSM_PAL_BLOCK_EMBODIMENT_CREATOR_HPP_
#define INCLUDE_COSM_PAL_BLOCK_EMBODIMENT_CREATOR_HPP_
...
class block_embodiment_creator {
 public:
  ...
  cpal::block_embodiment_variant operator()(const cpal::embodied_cube_block* block) const;
  cpal::block_embodiment_variant operator()(const cpal::embodied_ramp_block* block) const;
 ...
 private:
   ...
   * ARGoS API.
   */
  argos::CBoxEntity* ramp_bottom(const cpal::embodied_ramp_block* block,
   ...
   * ARGoS API.
   */
  argos::CBoxEntity* ramp_back(const cpal::embodied_ramp_block* block,
                               const rmath::radians& z_rotation,
                               const rtypes::type_uuid& parent_id) const;
   ...
   * ARGoS API.
   */
  argos::CBoxEntity* ramp_top(const cpal::embodied_ramp_block* block,
                              const rmath::radians& z_rotation,
                              const rtypes::type_uuid& parent_id) const;
...
#endif /* INCLUDE_COSM_PAL_BLOCK_EMBODIMENT_CREATOR_HPP_ */
