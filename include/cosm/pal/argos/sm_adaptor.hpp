 ...
 */
class sm_adaptor : public cpal::swarm_manager,
                         public ::argos::CLoopFunctions,
                         public rer::client<sm_adaptor> {
 public:
  sm_adaptor(void);
  ~sm_adaptor(void) override;

  /* Not copy constructable/assignable by default */
  sm_adaptor(const sm_adaptor&) = delete;
  const sm_adaptor& operator=(const sm_adaptor&) = delete;
