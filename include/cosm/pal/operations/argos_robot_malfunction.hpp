/**
 * \file argos_robot_malfunction.hpp
 *
...
class argos_robot_malfunction : public rer::client<argos_robot_malfunction> {
 public:
  argos_robot_malfunction(void) : ER_CLIENT_INIT("cosm.events.argos_robot_malfunction") {}
  ~argos_robot_malfunction(void) override = default;

  argos_robot_malfunction(const argos_robot_malfunction&) = delete;
  argos_robot_malfunction& operator=(const argos_robot_malfunction&) = delete;
