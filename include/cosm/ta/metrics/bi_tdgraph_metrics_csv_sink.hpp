/**
 * \file bi_tdgraph_metrics_csv_sink.hpp
 *
...
#ifndef INCLUDE_COSM_TA_METRICS_BI_TDGRAPH_METRICS_CSV_SINK_HPP_
#define INCLUDE_COSM_TA_METRICS_BI_TDGRAPH_METRICS_CSV_SINK_HPP_
 ...
 ******************************************************************************/
/**
 * \class bi_tdgraph_metrics_csv_sink
 * \ingroup ta metrics
 *
...
class bi_tdgraph_metrics_csv_sink final : public rmetrics::csv_sink {
 public:
   ...
   */
  bi_tdgraph_metrics_csv_sink(fs::path fpath_no_ext,
...
#endif /* INCLUDE_COSM_TA_METRICS_BI_TDGRAPH_METRICS_CSV_SINK_HPP_ */
