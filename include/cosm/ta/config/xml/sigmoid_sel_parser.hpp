...
#ifndef INCLUDE_COSM_TA_CONFIG_XML_SIGMOID_SEL_PARSER_HPP_
#define INCLUDE_COSM_TA_CONFIG_XML_SIGMOID_SEL_PARSER_HPP_
...
#endif /* INCLUDE_COSM_TA_CONFIG_XML_SIGMOID_SEL_PARSER_HPP_ */
