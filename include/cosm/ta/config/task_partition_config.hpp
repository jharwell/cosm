...
#ifndef INCLUDE_COSM_TA_CONFIG_TASK_PARTITION_CONFIG_HPP_
#define INCLUDE_COSM_TA_CONFIG_TASK_PARTITION_CONFIG_HPP_
...
#endif /* INCLUDE_COSM_TA_CONFIG_TASK_PARTITION_CONFIG_HPP_ */
