...
#ifndef INCLUDE_COSM_TA_CONFIG_SRC_SIGMOID_SEL_CONFIG_HPP_
#define INCLUDE_COSM_TA_CONFIG_SRC_SIGMOID_SEL_CONFIG_HPP_
...
#endif /* INCLUDE_COSM_TA_CONFIG_SRC_SIGMOID_SEL_CONFIG_HPP_ */
