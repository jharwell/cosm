...
class fs_output_manager : public rmetrics::fs_output_manager,
 ...
 public:
  ...
  /**
   * \brief Collect metrics from 3D controllers. Currently this includes:
   *
   * - \ref spatial::DistPosition3D
   * - \ref spatial::kMovement
   * - \ref spatial::kInterferenceCounts
 ...
 protected:
  ...
  /**
   * \brief Register metrics collectors for tracking kinematics.
   *
   * - \c kinematics/avg -> \ref ckmetrics::kinematics_metrics
   * - \c kinematics/dist -> \ref ckmetrics::kinematics_metrics
   */
