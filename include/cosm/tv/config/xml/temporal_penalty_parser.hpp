...
#ifndef INCLUDE_COSM_TV_CONFIG_XML_TEMPORAL_PENALTY_PARSER_HPP_
#define INCLUDE_COSM_TV_CONFIG_XML_TEMPORAL_PENALTY_PARSER_HPP_
...
#endif /* INCLUDE_COSM_TV_CONFIG_XML_TEMPORAL_PENALTY_PARSER_HPP_ */
