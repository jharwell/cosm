...
#ifndef INCLUDE_COSM_TV_CONFIG_XML_POPULATION_DYNAMICS_PARSER_HPP_
#define INCLUDE_COSM_TV_CONFIG_XML_POPULATION_DYNAMICS_PARSER_HPP_
...
class population_dynamics_parser final : public rconfig::xml::xml_config_parser {
 public:
   ...
   */
  inline static const std::string kXMLRoot = "population_dynamics";
...
#endif /* INCLUDE_COSM_TV_CONFIG_XML_POPULATION_DYNAMICS_PARSER_HPP_ */
