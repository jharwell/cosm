...
#ifndef INCLUDE_COSM_STEER2D_UNIFORM_BIAS_ANGLE_GENERATOR_HPP_
#define INCLUDE_COSM_STEER2D_UNIFORM_BIAS_ANGLE_GENERATOR_HPP_
 ...
 * distribution.
 */
class uniform_bias_angle_generator : public csteer2D::base_bias_angle_generator {
 public:
  ...
  uniform_bias_angle_generator& operator=(const uniform_bias_angle_generator&) = delete;
  uniform_bias_angle_generator(uniform_bias_angle_generator&&) = delete;
  uniform_bias_angle_generator& operator=(uniform_bias_angle_generator&&) = delete;
...
#endif /* INCLUDE_COSM_STEER2D_UNIFORM_BIAS_ANGLE_GENERATOR_HPP_ */
