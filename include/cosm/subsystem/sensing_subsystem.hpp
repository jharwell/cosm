 ...
 * chsubsystem::sensing_subsystem beyond the abstraction of available robot
 * sensors.
 *
...
class sensing_subsystem final : public chsubsystem::sensing_subsystem {
 public:
  ...
  /**
   * \brief Update the current time and position information for the robot (real
   * and discretized coordinates).
   */
