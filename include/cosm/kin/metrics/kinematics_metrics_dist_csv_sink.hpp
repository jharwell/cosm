 ...
 ******************************************************************************/
/**
 * \class kinematics_metrics_dist_csv_sink
 * \ingroup kin metrics
 *
 * \brief Sink for \ref kinematics_metrics and \ref kinematics_metrics_collector to
 *        output a \a distribution of kinematics metrics (i.e., showing data for
 *        each robot) to .csv.
 */
class kinematics_metrics_dist_csv_sink final : public rmetrics::csv_sink {
 public:
   ...
   */
  kinematics_metrics_dist_csv_sink(fs::path fpath_no_ext,
