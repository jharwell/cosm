...
#ifndef INCLUDE_COSM_CONTROLLER_CONFIG_PERCEPTION_XML_PHEROMONE_PARSER_HPP_
#define INCLUDE_COSM_CONTROLLER_CONFIG_PERCEPTION_XML_PHEROMONE_PARSER_HPP_
...
#endif /* INCLUDE_COSM_CONTROLLER_CONFIG_PERCEPTION_XML_PHEROMONE_PARSER_HPP_ */
