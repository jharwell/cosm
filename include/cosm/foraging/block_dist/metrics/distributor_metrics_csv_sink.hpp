...
#ifndef INCLUDE_COSM_FORAGING_BLOCK_DIST_METRICS_DISTRIBUTOR_METRICS_CSV_SINK_HPP_
#define INCLUDE_COSM_FORAGING_BLOCK_DIST_METRICS_DISTRIBUTOR_METRICS_CSV_SINK_HPP_
...
class distributor_metrics_csv_sink final : public rmetrics::csv_sink {
 public:
  ...
  std::list<std::string> csv_header_cols(
      const rmetrics::base_metrics_data*) const override;
...
#endif /* INCLUDE_COSM_FORAGING_BLOCK_DIST_METRICS_DISTRIBUTOR_METRICS_CSV_SINK_HPP_ */
