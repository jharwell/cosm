...
#ifndef INCLUDE_COSM_FORAGING_CONFIG_BLOCK_MANIFEST_HPP_
#define INCLUDE_COSM_FORAGING_CONFIG_BLOCK_MANIFEST_HPP_
...
#endif /* INCLUDE_COSM_FORAGING_CONFIG_BLOCK_MANIFEST_HPP_ */
